...
if minetest.settings:get_bool("archaeology_check_sus", false) then
    minetest.register_tool("archaeology:check_sus", {
        ...
        on_use = function(itemstack, user, pointed_thing)
            ...
            if placed == "true" then
                minetest.chat_send_player(name, S("That suspicious node has been placed (@1) by player @2.", core.colorize("grey", S("In creative? @1", creative)), core.colorize("lightgrey", placed_by)))
                return
            end
            minetest.chat_send_player(name, core.colorize("lime", S("This suspicious node has been generated by mapgen nearby player!")))
        end,
    })
end
